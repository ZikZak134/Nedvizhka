...
def get_token():
    ...
    # FIX: Use JSON body and correct endpoint
...
def create_property(token, image_url, video_url):
    ...
    data = {
        ...
        "latitude": 55.75,
        "longitude": 37.61,
        # API requires fully qualified URL if it's external, or path if internal.
        # But our upload endpoint returns a path relative to static mount /uploads
        # Ensure we pass what the frontend expects.
        # Use BOTH uploaded and external for robust test
...
def main():
    try:
        ...
        print(f"Uploaded Video URL: {vid_url}")
